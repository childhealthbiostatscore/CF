...
chco_cgm$Date = lubridate::date(parse_date_time(chco_cgm$date_cgm_placement,
                                                orders = c("mdyHM","mdy")))
...
# glycemic 279
montana_glycemic_registry <- read_csv("./Prepost Triakfta/Data_Cleaned/montana_glycemic_registry.csv") # looks identical
###################################
