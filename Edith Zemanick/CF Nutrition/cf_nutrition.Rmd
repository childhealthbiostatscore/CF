...
# Filter 
df = df %>% filter(`Patient ID` %in% two_measures & `Patient ID` %in% after_measure)
```
...
[2]: paste0('Treated with ivacaftor or ETI (or both) from 2008-2021 (n = ', length(unique(mods$`Patient ID`)),')')
[3]: paste0('In our dataset (n = ',length(unique(df$`Patient ID`)),')')
[4]: paste0('Treated with ivacaftor alone from 2008-2021 (n = ', n_kaly,')')
[5]: paste0('Treated with ETI alone from 2008-2021 (n = ', n_tri,')')
[6]: paste0('Treated with ivacaftor AND ETI from 2008-2021 (n = ',')')
[7]: paste0('At least two Vitamin A measures (n = ',')')
[8]: paste0('At least two Vitamin A measures (n = ',')')
[9]: paste0('At least two Vitamin A measures (n = ',')')
")
```
