...
df$geno_risk <- factor(df$geno_risk,
    levels = c(
        "Mild/Mild", "Mild/Severe", "Mild/Unknown", "Severe/Mild", "Severe/Severe",
        "Severe/Unknown", "Unknown/Severe", "Unknown/Unknown", "Not CF/Not CF"
    ),
...
df$geno_class <- factor(df$geno_class,
    levels = c(
        "F508del/F508del", "F508del/MF", "F508del/RF", "F508del/Unknown",
        "MF/F508del", "MF/MF", "MF/RF", "MF/Unknown", "RF/F508del", "RF/MF",
        "RF/Unknown", "Unknown/F508del", "Unknown/MF", "Unknown/Unknown",
        "Not CF/Not CF"
    ),
    labels = c(
        "MF/MF", "MF/MF", "MF/RF", "MF/U", "MF/MF", "MF/MF", "MF/RF", "MF/U",
        "MF/RF", "MF/RF", "RF/U", "MF/U", "MF/U", "U", "Not CF"
    )
)
# Organize columns
df <- df %>%
...
```{r results='asis'}
summary(tableby(`Genotype Class` ~ Sex + Age + Na + Cl + `Na:Cl` + K,
    data = df, control = mycontrols
))
```
...
```{r results='asis'}
summary(tableby(`Genotype Risk` ~ Sex + Age + Na + Cl + `Na:Cl` + K,
    data = df, control = mycontrols
))
```
