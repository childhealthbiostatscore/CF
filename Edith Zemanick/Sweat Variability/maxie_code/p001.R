...
setwd("/Volumes/PEDS/RI Biostatistics Core/Shared/Shared Projects/Vigers/CF/Edith Zemanick/Sweat Test/Background/Previous Work/data")
...
source("~/GitHub/CF/Edith Zemanick/Sweat Test/maxie_code/severity.R")
...
shared_legend <- extract_legend(box1)
