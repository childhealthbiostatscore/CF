...
# Write to CSV
df.to_csv("/Volumes/PEDS/RI Biostatistics Core/Shared/Shared Projects/Vigers/CF/Emily Muther/Mental Health Screening/Data_Cleaned/cf_mental_health_screening.csv")
```
