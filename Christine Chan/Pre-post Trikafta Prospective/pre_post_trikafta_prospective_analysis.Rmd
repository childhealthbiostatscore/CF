...
```{r results="asis"}
plot_vars = c("Weight..kg.","weightz","BMIz","Fat.Mass.Index..FMI...","Fat.Free.Mass.Index...FFMI.","`Glucose iAUC`","c.peptide.0.minute","`C Peptide iAUC`","iAUC_ratio","`C Peptide ODI`","`Adapted Matsuda`","homa2IR","FEV1..","FVC....")
