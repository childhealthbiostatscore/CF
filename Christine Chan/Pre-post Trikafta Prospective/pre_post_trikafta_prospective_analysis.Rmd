...
knitr::opts_knit$set(root.dir = "/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/CF")
```
...
ggplot(df,aes(x = Event.Name, y = A1C.result,fill = Event.Name)) + 
  geom_boxplot(coef=0,alpha = 0.5,outlier.shape = NA) + geom_jitter(width = 0.15) + 
