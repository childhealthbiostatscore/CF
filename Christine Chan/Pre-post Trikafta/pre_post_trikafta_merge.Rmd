...
###### IMPORT UW DATA #############
uw_registry <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_registry.csv") #cffid and start
uw_bmi <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_bmi.csv") # date, cffid, height, bmi (height bmi need rename)
uw_pft <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_pft.csv") # datee, cffid, fev, fvc need renaming
uw_cgm <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_cgm.csv") # same code as montana
uw_demo <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_demo.csv") 
uw_genotypes <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_registry.csv") # no genotype data here?
uw_glycemic <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_glycemic.csv") # looks good, same as chco
uw_gtubes <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_gtubes.csv") # rename date of encounter to date
uw_pancreatic <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/uw_pancreatic.csv") # same as montana, no pancreatic data though

###################################

###### IMPORT UM DATA ########
um_all <- read_csv("S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/um_all.csv")
###################################
...
write.csv(analysis_data, file = "S:/Vigers/CF/Christine Chan/Prepost Triakfta/Data_Cleaned/analysis_data.csv")
```