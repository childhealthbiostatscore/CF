...
table_dat$CF_hypo_60[table_dat$CF == "No" & table_dat$hypo_60 == "No"] <- "HC/No-Hypo"
...
table_dat$CF_hypo_70[table_dat$CF == "No" & table_dat$hypo_70 == "No"] <- "HC/No-Hypo"
...
kbl(ptab, caption = "Pairwise p-values") %>%
  column_spec(2, background = 
                ifelse(ptab$`CF/Hypo vs CF/No-Hypo` < 0.05, "red", "white")) %>%
  column_spec(3, background = 
                na.fill(ifelse(ptab$`CF/Hypo vs HC/Hypo` < 0.05, 
                               "red", "white"), "white)")) %>%
  column_spec(4, background = 
                na.fill(ifelse(ptab$`CF/Hypo vs HC/No-Hypo` < 0.05, 
                               "red", "white"), "white)")) %>%
  column_spec(5, background = 
                na.fill(ifelse(ptab$`CF/No-Hypo vs HC/Hypo` < 0.05, 
                               "red", "white"), "white)")) %>%
  column_spec(6, background = 
                na.fill(ifelse(ptab$`CF/No-Hypo vs HC/No-Hypo` < 0.05, 
                               "red", "white"), "white)"))
```
...
p1 <- ggplot(data = table_dat, aes(y = matsuda_ins, x = CF_hypo_60, color = CF_hypo_60)) +
  ...
  geom_signif(
    comparisons = list(c("CF/Hypo", "CF/No-Hypo"), c("CF/Hypo", "HC/No-Hypo")),
    color = "black",
    y_position = c(45, 50),
...
p2 <- ggplot(data = table_dat, aes(y = homa_ir, x = CF_hypo_60, color = CF_hypo_60)) +
  ...
  geom_signif(
    comparisons = list(c("CF/Hypo", "CF/No-Hypo")),
    color = "black",
    map_signif_level = function(p) sprintf("p = %.2g", p)
  ) +
  theme_light() +
...
kbl(ptab, caption = "Pairwise p-values") %>%
  ...
  column_spec(4, background = na.fill(ifelse(ptab$`CF/Hypo vs HC/No-Hypo` < 0.05, "red", "white"), "white)")) %>%
  column_spec(5, background = na.fill(ifelse(ptab$`CF/No-Hypo vs HC/Hypo` < 0.05, "red", "white"), "white)")) %>%
  column_spec(6, background = na.fill(ifelse(ptab$`CF/No-Hypo vs HC/No-Hypo` < 0.05, "red", "white"), "white)"))
```
