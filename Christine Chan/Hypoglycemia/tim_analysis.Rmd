...
for (subject in auc_df$subject_id){
  ...
  sub_df <- auc_df %>% filter(subject_id == subject) %>% select(ends_with("gip")) 
  ...
  if(length(gipn_temp) > 0){
    gip_nadir_time <- c(gip_nadir_time,
                        gipn_temp[[1]][1])
  }
  else {
    gip_nadir_time <- c(gip_nadir_time,
  ...
  sub_df <- auc_df %>% filter(subject_id == subject) %>% select(ends_with("glp1")) 
  ...
  if(length(gipp_temp) > 0){
    glp1_peak_time <- c(glp1_peak_time,
                        glp1p_temp[[1]][1])
  }
  else {
    glp1_peak_time <- c(glp1_peak_time,
  ...
  if(length(glp1n_temp) > 0){
    glp1_nadir_time <- c(glp1_nadir_time,
                         glp1n_temp[[1]][1])
  }
  else {
    glp1_nadir_time <- c(glp1_nadir_time,
