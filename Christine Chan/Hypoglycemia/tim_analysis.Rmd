...
kbl(ptab, caption = "Pairwise p-values") %>%
  ...
  column_spec(3, background = 
                na.fill(ifelse(ptab$`CF/Hypo vs No-CF/Hypo` < 0.05, 
                               "red", "white"), "white)")) %>%
  column_spec(4, background = 
                na.fill(ifelse(ptab$`CF/Hypo vs No-CF/No-Hypo` < 0.05, 
                               "red", "white"), "white)")) %>%
  column_spec(5, background = 
                na.fill(ifelse(ptab$`CF/No-Hypo vs No-CF/Hypo` < 0.05, 
                               "red", "white"), "white)")) %>%
  column_spec(6, background = 
                na.fill(ifelse(ptab$`CF/No-Hypo vs No-CF/No-Hypo` < 0.05, 
                               "red", "white"), "white)"))
```
...
p1 <- ggplot(data = table_dat, aes(y = matsuda_ins, x = CF_hypo_60, color = CF_hypo_60)) +
  ...
  geom_signif(
    comparisons = list(c("CF/Hypo", "CF/No-Hypo"), c("CF/Hypo", "No-CF/No-Hypo")),
    color = "black",
    y_position = c(45, 50),
