...
annual <- read.csv("~/Documents/Work/Christine Chan/CF registry data/CFF19_Annualized_Del1.csv",na.strings = c("", "N/A")
)
...
demogs = read.csv("~/Documents/Work/Christine Chan/CF registry data/CFF19_DemogCFDiag_Del1.csv")
...
log_reg = function(year){
  ...
  df = annual %>% 
    ...
    select(eDWID,Age_YrEnd,Gender,MutClass,A_IsOnEnzymes,A_FEV1,A_FEV1_pct_predicted,
