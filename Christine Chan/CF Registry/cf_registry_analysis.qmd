...
In @tbl-screening, people with CFRD (by either registry definition or OGTT) and those under 10 were excluded. Screening rate is calculated as the number of people with OGTTs divided by the total number of people seen in clinic that year.