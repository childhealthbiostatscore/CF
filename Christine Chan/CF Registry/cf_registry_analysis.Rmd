...
knitr::opts_knit$set(root.dir = "~/Dropbox/Work/CHCO/Christine Chan/CF registry data")
```
...
df$second_smoke <- factor(df$smoking, levels = 1:4, labels = c(
  "No",
  "Occasionally",
  "Yes, Regularly, less than 1 ppd",
  "Yes, Regularly, 1 ppd or more"
...
save(df,file = "formatted_data.Rdata")
```
