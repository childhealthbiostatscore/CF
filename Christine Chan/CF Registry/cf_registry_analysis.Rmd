...
df$employment = sub(sub("1","Part Time",df$employment))
df$employment = sub(sub("2","Full time homemaker",df$employment))
df$employment = sub(sub("3","Full time employment",df$employment))
df$employment = sub(sub("4","Unemployed",df$employment))
df$employment = sub(sub("5","Student",df$employment))
df$employment = sub(sub("6","Disabled",df$employment))
df$employment = sub(sub("7","Retired",df$employment))
...
t1_df = df %>% group_by(eDWID,Period) %>% 
  summarise(Age = max(Age_YrEnd,na.rm = T),Race = last(na.omit(Race)),
