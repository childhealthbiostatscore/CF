...
# Yes/no variables
df$A_IsOnEnzymes = factor(df$A_IsOnEnzymes,ordered = T,
                          levels = 0:1,labels = c("No","Yes"))
df$A_salt_supplement = factor(df$A_salt_supplement,ordered = T,
                              levels = 0:1,labels = c("No","Yes"))
df$A_cf_vitamins = factor(df$A_cf_vitamins,ordered = T,
                          levels = 0:1,labels = c("No","Yes"))
df$A_dornasealfa = factor(df$A_dornasealfa,ordered = T,
                          levels = 0:1,labels = c("No","Yes"))
df$A_pulmonarycomplications4 = factor(df$A_pulmonarycomplications4,ordered = T,
                                      levels = 0:1,labels = c("No","Yes"))
df$A_pulmonarycomplications5 = factor(df$A_pulmonarycomplications5,ordered = T,
                                      levels = 0:1,labels = c("No","Yes"))
df$A_othercomplications9 = factor(df$A_othercomplications9,ordered = T,
                                      levels = 0:1,labels = c("No","Yes"))
df$A_hepatobiliary1_3 = factor(df$A_hepatobiliary1_3,ordered = T,
                                      levels = 0:1,labels = c("No","Yes"))
