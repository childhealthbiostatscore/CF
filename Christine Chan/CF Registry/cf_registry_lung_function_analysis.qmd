...
# Diagnosed with CFRD between 2004 - 2018
...
mod_df |>
  ...
  write.csv(
    .,
    file = "./Data_Clean/fev1_model_data_2004.csv",
    row.names = FALSE,
    na = ""
  )
# Tables
...
mod_df |>
  filter(ReviewYear == first_cfrd, a1c_ogtt %in% c("OGTT", "HbA1c Only")) |>
...
```{r}
# Contrasts - probably a more elegant way to do this but oh well
neither_m_5 = rep(0, times = 33)
neither_m_5[1] = 1
neither_m_1 = rep(0, times = 33)
neither_m_1[5] = 1
neither_0 = rep(0, times = 33)
neither_0[6] = 1
neither_1 = rep(0, times = 33)
neither_1[7] = 1
neither_5 = rep(0, times = 33)
neither_5[11] = 1
hba1c_m_5 = rep(0, times = 33)
hba1c_m_5[12] = 1
hba1c_m_1 = rep(0, times = 33)
hba1c_m_1[16] = 1
hba1c_0 = rep(0, times = 33)
hba1c_0[17] = 1
hba1c_1 = rep(0, times = 33)
hba1c_1[18] = 1
hba1c_5 = rep(0, times = 33)
hba1c_5[22] = 1
ogtt_m_5 = rep(0, times = 33)
ogtt_m_5[23] = 1
ogtt_m_1 = rep(0, times = 33)
ogtt_m_1[27] = 1
ogtt_0 = rep(0, times = 33)
ogtt_0[28] = 1
ogtt_1 = rep(0, times = 33)
ogtt_1[29] = 1
ogtt_5 = rep(0, times = 33)
ogtt_5[33] = 1
# Test contrasts
F <- contrast(
  emm,
...
Adjusted for age at diagnosis, number of FEV1 measures, sex, mutation class, pancreatic enzyme use, and CFRD treatment.
