...
base_dir <- switch(
  ...
  "Tims-MacBook-Air.local" = "/Users/tvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers",
  "Tims-Mac-mini.local" = "/Users/tvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers",
  "Mac" = "/Users/tvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers",
  "Tims-Mac-Studio.local" = "/Users/tvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers"
)
data_dir <- switch(
  Sys.info()["nodename"],
...
p = ggplot(
  ...
  labs(
    ...
    caption = "Results are averaged over the levels of age at diagnosis, number of FEV1 measures,\n sex, mutation class, pancreatic enzyme use, and insurance status."
  ) +
  theme_bw(base_size = 15)
p
ggsave(
  "./Dissemination/Figures/fev1_by_screen_method.png",
  plot = p,
  width = 9,
  height = 6,
  units = "in",
...
p
ggsave(
  "./Dissemination/Figures/fvc_by_screen_method.png",
  plot = p,
  width = 9,
  height = 6,
  units = "in",
