...
era1 <- coxph(f, data = annual[as.numeric(annual$time_period) == 1, ], cluster = eDWID)
era2 <- coxph(f, data = annual[as.numeric(annual$time_period) == 2, ], cluster = eDWID)
era3 <- coxph(f, data = annual[as.numeric(annual$time_period) == 3, ], cluster = eDWID)
```
