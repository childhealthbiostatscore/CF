...
home_dir <- switch(
  Sys.info()["sysname"],
  "Darwin" = "/Users/tvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers/CF/Christine Chan/CF Registry",
  "Windows" = "C:/Users/tvigers/OneDrive - The University of Colorado Denver/Vigers/CF/Christine Chan/CF Registry",
  "Linux" = "/home/tvigers/OneDrive/Vigers/CF/Christine Chan/CF Registry"
)
github_dir <- switch(
  Sys.info()["sysname"],
  "Darwin" = "/Users/timvigers/Documents/GitHub",
  "Windows" = "C:/Users/tvigers/GitHub",
  "Linux" = "/home/tvigers/GitHub"
)
...
P values below are FDR-adjusted for multiple comparisons.
...
ggplot(roc_df, aes(x = `OGTT 2-hour`, y = hgba1c)) +
  ...
  scale_y_continuous(
    breaks = c(5, 5.3, 5.5, 5.7, 7, 10, 12),
