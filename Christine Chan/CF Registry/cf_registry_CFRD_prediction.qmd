...
t1 <- tableby(cfrd_registry ~ Age_YrEnd + Gender + Race + Hispanicrace + A_IsOnEnzymes + NumPulmExacerbation + A_FEV1_pct_predicted + bmi, data = surv_reg[surv_reg$eDWID %in% reg_include, ])
summary(t1)
```
...
# Combine
joint_fit_value <- jointModel(lme_fit_a1c, cox_fit, timeVar = "Age_YrEnd", parameterization = "value")
