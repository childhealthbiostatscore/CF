...
white_vs_black_pre <- glht(
  change_mod,
  "Years + `Years:RaceBlack or African American` = 1.13856555"
)
...
white_vs_black_post <- glht(
  change_mod,
  "Years + `Years:RaceBlack or African American` + slope_change_years + `RaceBlack or African American:slope_change_years` = 2.63633"
)
