...
load("/Users/timvigers/Library/CloudStorage/Dropbox/Work/Vigers/CF/Kamyron Jordan/Racial and Ethnic Differences in ETI/Data_Cleaned/analysis_dataset.RData")
```
...
```{r}
ggplot(annual, aes(x = Age_YrEnd, y = mean_ppFEV)) +
  geom_smooth(aes(color = race), se = F)
```
