...
library(tidyfun)
# Data import
sleep = read.csv("C:/Users/timbv/Dropbox/Work/Vigers/CF/Christine Chan/CGM and FDA/Data_Raw/sleep.csv",
                 na.strings = "")
...
# CGMs
# cleandata("C:/Users/timbv/Dropbox/Work/Vigers/CF/Christine Chan/CGM and FDA/Data_Raw/CGM",
#           "C:/Users/timbv/Dropbox/Work/Vigers/CF/Christine Chan/CGM and FDA/Data_Clean/CGM",
#           removegaps = F)
cgms = list.files("C:/Users/timbv/Dropbox/Work/Vigers/CF/Christine Chan/CGM and FDA/Data_Clean/CGM",
                  full.names = T)
...
# Find those where all glucose values are missing
ydf = do.call(rbind,ys[keep])
colnames(ydf)[1] = ".id"
# Save
save(ydf,file = "C:/Users/timbv/Dropbox/Work/Vigers/CF/Christine Chan/CGM and FDA/R_Objects/ydf.Rdata")
```
...
```{r}
#| include: false
# load("C:/Users/timbv/Dropbox/Work/Vigers/CF/Christine Chan/CGM and FDA/R_Objects/fpca_sc_fit.Rdata")
```

## Questions for the Group

-   What is the best way to pick the order of basis functions, etc.? Visually?
