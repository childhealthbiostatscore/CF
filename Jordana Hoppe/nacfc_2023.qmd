...
fleiss("Achromobacter.not.xylosoxidans.",
       bug_name = "Achromobacter (not xylosoxidans)")
```
...
fleiss("Pseudomonas.species..not.aeruginosa.",
       bug_name = "Pseudomonas (not aeruginosa)")
```
...
colnames(f) = c("ID",paste("MSSA",c("Clinic","Delayed","Home")),
