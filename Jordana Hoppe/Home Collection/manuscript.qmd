...
agreement <- function(result_pattern, df = data) {
  ...
  p <- bar_plot + venn + plot_annotation(tag_levels = c("a", "b"))
  cat("\n")
  cat("\n")
  show(p)
  cat("\n")
...
p_benefits <- gglikert(benefits_df, add_totals = F) +
  ggtitle("Benefits") +
  theme(
    axis.text.x = element_blank(), axis.title.x = element_blank(),
    legend.position = "none"
  ) +
  scale_fill_manual(values = c("Unchecked" = "#D8B365", "Checked" = "#5AB4AC"))
p_barriers <- gglikert(barriers_df, reverse_likert = T, add_totals = F) +
  ggtitle("Barriers") +
  scale_fill_manual(values = c("Unchecked" = "#5AB4AC", "Checked" = "#D8B365"))
...
p <- p3 / p5 + plot_annotation(tag_levels = c("a", "b"))
p
