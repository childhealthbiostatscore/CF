...
home_dir <- switch(Sys.info()["sysname"],
  "Darwin" = "/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers/CF/Lilah Melzer/Lilah Cough Monitor",
...
t1 <- tableby(Diagnosis ~ nih_sex + age_at_consent + height_perc + weight_perc +
  nih_race + nih_ethnicity + cftr_mod + cftr_mod_type + Genotype + pre_fev_pp +
  total_sleep, data = demo, control = mycontrols)
...
fig2 <- ggplot(agg_counts[!is.na(agg_counts$Coughs), ], aes(
  ...
  xlim(c(0, 100)) +
  theme_bw() +
  scale_color_manual(values = c("#003092", "#FFAB5B")) +
