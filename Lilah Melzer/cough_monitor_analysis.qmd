...
#| warning: false
# Import use data
start_end <- read.csv("/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers/CF/Lilah Melzer/Home Nighttime Cough Monitoring/Data_Clean/Start and end dates.csv",
  na.strings = ""
)
start_end$Start <- mdy(start_end$Start)
start_end$End <- mdy(start_end$End)
vacations <- read.csv("/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers/CF/Lilah Melzer/Home Nighttime Cough Monitoring/Data_Clean/Vacation days.csv",
  na.strings = ""
)
...
dates <- start_end %>%
  rowwise() %>%
  transmute(sid,
    Date = list(seq(Start, End - 1, by = "day"))
  ) %>%
  unnest(Date)
# Import counts
agg_counts <- read.csv(
  "/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers/CF/Lilah Melzer/Home Nighttime Cough Monitoring/Data_Raw/Cough_w_TotalCounts_0824 - Cough_agg_w_count_0828.csv",
...
# Save
write.csv(agg_counts, file = "/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Vigers/CF/Lilah Melzer/Home Nighttime Cough Monitoring/Data_Clean/cleaned_aggregated_counts.csv", na = "", row.names = F)
# Per night
